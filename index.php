  ...
  <main class="page-content">
    <div data-autoplay="false" data-slide-effect="fade" class="swiper-container swiper-slider">
      <div class="swiper-wrapper">
        <div class="swiper-slide"><img src="images/website2.jpg" alt="" width="1920" height="600"/>
        ...
        <div class="swiper-slide"><img src="images/website3.jpg" alt="" width="1920" height="600"/>
          <div class="swiper-slide-caption">
             <div class="shell text-center text-sm-left">
              <div class="range">
        ...
        <div class="swiper-slide"><img src="images/website4.jpg" alt="" width="1920" height="600"/>
          <div class="swiper-slide-caption">
         <div class="shell text-center text-sm-left">
              <div class="range">
    ...
    <section>
      ...
      <div class="section-top-40 section-bottom-60 section-sm-bottom-110">
          ...
          <div class="range">
            <div data-arrows="true" data-loop="true" data-dots="false" data-swipe="true" data-items="1" data-sm-items="3" data-md-items="3" data-lg-items="4" data-xl-items="6" data-slide-to-scroll="1" data-mobile-center-mode="true" data-sm-center-mode="false" data-center-padding="30px" data-sm-center-padding="0.5" class="slick-slider slick-slider-style-1">
              <div class="item height-fill">
                <div class="product"><a href="services.php#ice-maker-repair" class="product-image"><img src="images/223x227.jpg" alt="" width="223" height="227"/></a>
                  <div class="product-caption">
                    <div class="divider divider-sm divider-primary"></div>
                    <div class="product-title">
                      <h5><a href="services.php#ice-maker-repair">Ice Maker Repair</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="item height-fill">
                <div class="product"><a href="services.php#stove-repair" class="product-image"><img src="images/223x227.jpg" alt="" width="223" height="227"/></a>
                  <div class="product-caption">
                    <div class="divider divider-sm divider-primary"></div>
                    <div class="product-title">
                      <h5><a href="services.php#stove-repair">Stove Repair</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="item height-fill">
                <div class="product"><a href="services.php#microwave-repair" class="product-image"><img src="images/223x227.jpg" alt="" width="223" height="227"/></a>
                  <div class="product-caption">
                    <div class="divider divider-sm divider-primary"></div>
                    <div class="product-title">
                      <h5><a href="services.php#microwave-repair">Microwave Repair</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="item height-fill">
                <div class="product"><a href="services.php#washer-repair" class="product-image"><img src="images/223x227.jpg" alt="" width="223" height="227"/></a>
                  <div class="product-caption">
                    <div class="divider divider-sm divider-primary"></div>
                    <div class="product-title">
                      <h5><a href="services.php#washer-repair">Washer Repair</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="item height-fill">
                <div class="product"><a href="services.php#refrigerator-repair" class="product-image"><img src="images/223x227.jpg" alt="" width="223" height="227"/></a>
                  <div class="product-caption">
                    <div class="divider divider-sm divider-primary"></div>
                    <div class="product-title">
                      <h5><a href="services.php#refrigerator-repair">Refrigerator Repair</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="item height-fill">
                <div class="product"><a href="services.php#range-hood-repair" class="product-image"><img src="images/223x227.jpg" alt="" width="223" height="227"/></a>
                  <div class="product-caption">
                    <div class="divider divider-sm divider-primary"></div>
                    <div class="product-title">
                      <h5><a href="services.php#range-hood-repair">Range Hood Repair</a></h5>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="shell offset-top-30 offset-sm-top-40">
          <div class="text-center"><a href="services.php" class="btn btn-primary min-width-230">view all services</a></div>
        </div>
      </div>
    </section>
    <section data-on="false" data-lg-on="true" class="rd-parallax bg-gray-base rd-parallax-overlay">
      <div data-speed="0.5" data-type="media" data-url="images/patrick-hendry-6xeDIZgoPaw-unsplash.jpg" class="rd-parallax-layer"></div>
              ...
              <blockquote class="quote-variant-1">
                <div class="quote-meta">
                  <div class="unit unit-spacing-xs unit-middle unit-horizontal">
                    <div class="unit-left">
                      <figure class="quote-image"><img src="images/47x47.jpg" alt="" width="47" height="47"/> </figure>
                    </div>
          ...
          <div data-isotope-layout="moduloColumns" class="isotope isotope-spacing-1">
            <div class="col-sm-6 col-lg-4 isotope-item">
              <article class="post post-variant-1">
                <figure class="post-image"><img src="images/370x247.jpg" alt="" width="370" height="247"/> </figure>
                <div class="post-body">
